classdef H9_se_nav_v8 < PulseSequence
    ...
    methods
        function pulse = H9_se_nav_v8
            pulse@PulseSequence;
            pulse.pulseSequenceName = 'Inversion Recovery Spin Echo';
            pulse.pprFile = 'C:\Scanner\H9_scanner\PulseSequences\H9_se_nav_v8.PPR';
            pulse.dBdt = 7;
            pulse.useMode = 3;
    ...
    methods (Static)
        ...
        function file = Reorder(file)
           ...
           save(processed_dir,'saveList','-append');
            else

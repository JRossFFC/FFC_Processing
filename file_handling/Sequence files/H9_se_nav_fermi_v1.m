classdef H9_se_nav_fermi_v1 < PulseSequence
    ...
    methods
        function pulse = H9_se_nav_fermi_v1
            pulse@PulseSequence;
            pulse.pulseSequenceName = 'Bloch Siegert Spin Echo';
            pulse.pprFile = 'C:\Scanner\H9_scanner\PulseSequences\H9_se_nav_fermi_v1.PPR';
            pulse.dBdt = 7;
            pulse.useMode = 3;
        ...
        function out = MakeWaveformProfile(pulse)
            ...
            % here the slices are done sequencially so they need to be
            % treated as separate acquisitions for the waveform generator
            nSlice = GetPprParameter(pulse.pprParamList,'no_slices',1);
            ...
            pulse.waveformProfile.generator.averageNumber = GetPprParameter(pulse.pprParamList,'no_averages',1)*nSlice;

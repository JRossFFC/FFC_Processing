classdef H9_se_nav_v9_t1rho < PulseSequence
    ...
    methods
        function pulse = H9_se_nav_v9_t1rho
            pulse@PulseSequence;
            pulse.pulseSequenceName = 'Inversion Recovery Spin Echo';
            pulse.pprFile = 'C:\Scanner\H9_scanner\PulseSequences\H9_se_nav_v9_t1rho.PPR';
            pulse.dBdt = 7;
            pulse.useMode = 3;
...
%                 end
                ...
                corrected_stack = (iterative_images_correction_v7(AA,0.20,10,0.0015,background));                

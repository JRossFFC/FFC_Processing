classdef H9_se_nav_v6 < PulseSequence
    ...
    methods
        function pulse = H9_se_nav_v6
            pulse@PulseSequence;
            pulse.pulseSequenceName = 'Inversion Recovery Spin Echo';
            pulse.pprFile = 'C:\Scanner\H9_scanner\PulseSequences\H9_se_nav_v7.PPR';
            pulse.dBdt = 7;
            pulse.useMode = 3;
    ...
    methods (Static)
        ...
        function file = Reorder(file)
            ...
            if isempty(matfile.dataProcessed)||(file.reprocess==1)
                ...
                corrected_stack = (iterative_images_correction_v7(AA,0.20,10,0.00015,background));
%                 corrected_stack = (iterative_images_correction_v7(AA,0.20,50,0.00015,background));

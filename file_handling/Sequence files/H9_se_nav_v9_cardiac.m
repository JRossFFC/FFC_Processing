classdef H9_se_nav_v9_cardiac < PulseSequence
    ...
    methods
        function pulse = H9_se_nav_v9_cardiac
            pulse@PulseSequence;
            pulse.pulseSequenceName = 'Inversion Recovery Spin Echo with Triggering';
            pulse.pprFile = 'C:\Scanner\H9_scanner\PulseSequences\H9_se_nav_v9_cardiac.PPR';
            pulse.dBdt = 7;
            pulse.useMode = 3;

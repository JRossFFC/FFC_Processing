classdef SingleFieldGenerator < WaveformGenerator
    ...
    methods
        ...
        function wavegen = SingleFieldGenerator(varargin)
            wavegen@WaveformGenerator;
            wavegen.name = 'Relaxometry at readout field';
...
%                     wavegen.waveform
            ...
            wavegen.waveform.waveList{wavegen.waveformIndex}.iterationNumber = GetPprParameter(wavegen.waveform.pulse.pprParamList,'no_experiments',1);
            wavegen.waveform.experimentNumber = wavegen.waveform.waveList{wavegen.waveformIndex}.iterationNumber;
        end   
